...
const int AX1_MIN_SPEED_for = 30;
const int AX1_MIN_SPEED_rev = -30;
...
int AX1_accel_ramp = 8000;
int AX1_decel_ramp = 5000;
int AX1_max_rpm = 1330;
double AX1_steps_per_round = 400;
...
const int AX2_MIN_SPEED_for = 30;
const int AX2_MIN_SPEED_rev = -30;
...
int AX2_accel_ramp = 2000;
int AX2_decel_ramp = 1000;
int AX2_max_rpm = 1560;
double AX2_steps_per_round = 400;
